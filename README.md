...
* [cite_start]**Backend:** Sunucusuz mimari (Serverless) yaklaşımıyla Google Firebase (Cloud Firestore ve Authentication) kullanılmıştır[cite: 26, 78, 190, 251].
* [cite_start]**Durum Yönetimi:** Hafif ve performanslı bir yapı sunan Context API tercih edilmiştir[cite: 182, 253].
...
## Yazılım Mimarisi
[cite_start]Proje, mantıksal katmanların birbirinden ayrıldığı **MVVM (Model-View-ViewModel)** tasarım deseni ve **Bileşen Tabanlı Mimari** üzerine kurgulanmıştır[cite: 25, 131, 177]:
...
## Temel Özellikler
* [cite_start]**Rol Tabanlı Erişim Kontrolü (RBAC):** Öğrenci, Firma ve Admin rolleri için ayrıştırılmış yetki ve arayüzler sunulur[cite: 29, 30, 103, 333].
* [cite_start]**Admin Onay Mekanizması:** Sisteme girilen ilanların yönetici denetiminden geçmeden yayına alınmaması sayesinde yüksek içerik kalitesi sağlanır[cite: 31, 103, 147].
...
* [cite_start]**Akıllı Takip:** Başvurulan ve favoriye alınan ilanlar için gerçek zamanlı senkronizasyon desteği mevcuttur[cite: 114, 220].

## Yazılım Kalitesi ve Test Süreçleri
* [cite_start]**Birim Testler:** Jest kütüphanesi kullanılarak çekirdek iş mantığı üzerinde 33 kritik fonksiyon başarıyla test edilmiştir[cite: 222, 288, 290].
* [cite_start]**Statik Kod Analizi:** SonarQube entegrasyonu ile Güvenlik ve Bakım Yapılabilirlik kategorilerinde en yüksek not olan **A derecesi** alınmıştır[cite: 316, 319, 324].
* [cite_start]**Kod Kalitesi:** Modüler yapı sayesinde kod tekrarı oranı %0.3 seviyesinde tutulmuştur[cite: 315, 324].
* [cite_start]**API Testleri:** Postman platformu üzerinden servis uç noktalarının veri bütünlüğü ve hata kodları doğrulanmıştır[cite: 297, 303].
...
## Proje Ekibi
* [cite_start]**Sevde Gül Şahin:** Proje Yönetimi, API Orkestrasyonu, Admin Paneli[cite: 14, 18].
* [cite_start]**Süeda Nur Sarıcan:** Firebase Entegrasyonu, Kimlik Doğrulama süreçleri, UI Geliştirme[cite: 15, 19].
* [cite_start]**Fatımanur Kantar:** Veri Modelleme, Test süreçleri, Dokümantasyon[cite: 16, 20].
